...
class Car extends ReLogoTurtle {
	...
	def step() {
		...
		if(UserObserver.startMove == false) {   //movimento geral pré ataque
			fd(0.5)
		...
		//carros da frente
		if(UserObserver.startMove == true) {
			ask(car(8)){
		...
		//carros de tras
		if(car(3).distance(enemies())>=6 && UserObserver.startMove == true) { //movimento pelotao 1(o que vai por baixo)
			ask(car(0)){
				face(car(3))
		...
		if(UserObserver.startMove == true && car(3).distance(enemies())<6) { //aproximação pós parabola
			ask(car(0)){
				//176
		...
		//carros do meio
		if(car(7).distance(enemies())>=6 && UserObserver.startMove == true) {  //movimento pelotão 2(o que vai por cima) em parabola
			ask(car(4)){
				face(car(7))
				fd(0.17)
			}
		...
		if(UserObserver.startMove == true && car(7).distance(enemies())<6) { //aproximação pós parabola
			ask(car(4)){
				//4
