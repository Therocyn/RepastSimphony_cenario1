...
class Car extends ReLogoTurtle {
	...
	def step() {
		...
		//carros de tras
		if(car(3).distance(enemies())>=6 && UserObserver.list.get(13)[1]=="1") { //movimento pelotao 1(o que vai por baixo)
			ask(car(0)){
				face(car(3))
		...
		if(UserObserver.list.get(13)[1]=="1" && car(3).distance(enemies())<6) { //aproximação pós parabola
			ask(car(0)){
				//176
		...
		//carros do meio
		if(car(7).distance(enemies())>=6 && UserObserver.list.get(13)[1]=="1") {  //movimento pelotão 2(o que vai por cima) em parabola
			ask(car(4)){
				face(car(7))
				fd(0.17)
			}
		...
		if(UserObserver.list.get(13)[1]=="1" && car(7).distance(enemies())<6) { //aproximação pós parabola
			ask(car(4)){
				//4
